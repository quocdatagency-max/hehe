...
function parseCSV(text: string): Promise<CSVRow[]> {
  return new Promise((resolve, reject) => {
    // Không dùng generic <CSVRow> vì trong một số môi trường build, Papa.parse bị coi là "untyped"
    // và TypeScript sẽ báo: "Untyped function calls may not accept type arguments".
    Papa.parse(text, {
      header: true,
      skipEmptyLines: true,
      dynamicTyping: false,
